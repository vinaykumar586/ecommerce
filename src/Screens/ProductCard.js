...
function ProductCard({item,cartDetails,setCartDetails,open,setOpen}) {
  ...
  return (
    ...
    <div className='product-card' onClick={() => setOpen(!open)}>
      <div>
        <Image src={item.productImages[0] || "https://i.pinimg.com/236x/a8/d4/57/a8d457a99271ce50a4cc537b4dd05e4b.jpg"} style={{width:"50px",height:"40px"}}/>
        </div>
